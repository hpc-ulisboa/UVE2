...
void core_kernel(void **x, void *x_array, void *y, void *y_err, void *sgd_model, DataType *intercept) {
...
void r2_score(void *y_fitted, void *y, void *result) {
...
#ifdef RUN_SIMPLE
void core_kernel(DataType **x, DataType *x_array, DataType *y, DataType *y_err, DataType *sgd_model, DataType *intercept) {
    int e, b, i, j;
    DataType yhat, raw_update, intercept_der;
...
void r2_score(DataType *y_fitted, DataType *y, DataType *result) {
